...
_load_legacy_step_definitions() {
    ...
    local -a legacy_steps=(
        ...
        "pre_analysis:step_00_analyze.sh:step0_analyze_changes"
        ...
        "test_execution:step_08_test_exec.sh:step8_execute_tests"
        "dependency_validation:step_09_dependencies.sh:step9_validate_dependencies"
        "code_quality_validation:step_10_code_quality.sh:step10_code_quality_validation"
        "context_analysis:step_11_5_context.sh:step10_context_analysis"
        "deployment_gate:step_11_deployment_gate.sh:step11_deployment_gate"
        "git_finalization:step_12_git.sh:step12_git_finalization"
        "markdown_linting:step_13_markdown_lint.sh:step13_markdown_linting"
        "prompt_engineer_analysis:step_14_prompt_engineer.sh:step14_prompt_engineer_analysis"
        "ux_analysis:step_15_ux_analysis.sh:step15_ux_analysis"
    )
