...
[[ -f "${STEP1_DIR}/documentation.sh" ]] && echo "✓ Main file exists" || echo "✗ Main file missing"
...
bash -n "${STEP1_DIR}/documentation.sh" && echo "✓ Main script syntax OK" || echo "✗ Syntax error"
...
source "${STEP1_DIR}/documentation.sh" 2>/dev/null && echo "✓ Main script loads" || echo "✗ Loading error"

echo ""
echo "Test 4: Line counts..."
wc -l "${STEP1_DIR}/documentation.sh" "${STEP1_DIR}/step_01_lib"/*.sh | tail -1
