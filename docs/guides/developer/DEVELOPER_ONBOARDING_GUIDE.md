...
cat docs/guides/developer/MODULE_DEVELOPMENT.md
```
...
vim docs/guides/user/examples.md
```
...
2. **Review module development guide**: [docs/guides/developer/MODULE_DEVELOPMENT.md](MODULE_DEVELOPMENT.md)
...
- **API Reference**: [docs/reference/api/LIBRARY_MODULES_COMPLETE_API.md](../api/LIBRARY_MODULES_COMPLETE_API.md)
