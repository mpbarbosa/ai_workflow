...
- Changed from "13 specialized personas" to "13 specialized personas (project-aware via `project_kinds.yaml` and `.workflow-config.yaml`)"
- Highlights the new context-awareness capability
