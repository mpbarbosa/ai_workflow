...
| AI Personas | 13 personas ✅ | 13 personas ✅ | ✅ |
...
Documentation claims "13 specialized personas" - this is **correct**:
...
**Note**: These 13 personas are implemented through 6 base prompt templates + project kind-specific variations in `ai_helpers.yaml` and `ai_prompts_project_kinds.yaml`.
