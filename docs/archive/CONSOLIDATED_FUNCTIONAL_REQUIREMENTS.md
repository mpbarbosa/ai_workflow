...
✅ [text](/path/to/file.md)  <!-- EXAMPLE PATTERN for validation testing - NOT A REAL LINK -->
✅ ![alt](/images/pic.png)  <!-- EXAMPLE PATTERN for validation testing - NOT A REAL LINK -->
...
⚠️  **BROKEN LINK**: [source_file] references missing file
   - Reference: /path/to/missing/file  # EXAMPLE pattern for validation testing - NOT A REAL PATH
   - Line [N]: [content]
