...
> **📚 CONSOLIDATED GUIDE AVAILABLE**: This document describes a specific fix. For the complete,  
> authoritative guide on third-party exclusions, see [**docs/THIRD_PARTY_EXCLUSION_GUIDE.md**](../reference/third-party-exclusion.md).
